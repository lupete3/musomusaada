        ...
        @can('afficher-rapport-credit')
            ...
            active @endif" wire:ignore.self>
                ...
                <ul class="menu-sub">
                    ...
                    <li class="menu-item @if (request()->routeIs('rapports.collectors')) active @endif">
                        <a href="{{ route('rapports.collectors') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-badge-check"></i>
                            <div data-i18n="Analytics">Aperçu Collecteurs</div>
                        </a>
                    </li>
